...
public class Window extends JFrame implements ActionListener {
	...
	protected final static String BUTTON_TEXT = "Start game !";
	...
	private JPanel createStartPanel() {
		...
		startPanel.setLayout(new BoxLayout(startPanel, BoxLayout.Y_AXIS));
			...
			JButton start_button = new JButton(BUTTON_TEXT);
					start_button.setAlignmentX(Component.CENTER_ALIGNMENT);
					start_button.setName(BUTTON_TEXT);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(sorce_name.equals(BUTTON_TEXT)) {
			setGameScore("0");
			setGamePanel();
	...
	private void setGamePanel() {
		...
		gamePanel.add(this.gameScoreLabel);
		...
		gamePanel.add(this.timeGameLabel);	
